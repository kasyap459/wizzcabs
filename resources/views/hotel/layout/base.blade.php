...
<html lang="en">
    ...
    <body style="background-image: url('{{asset('asset/customer/images/bg-02.jpg')}}');  background-size: cover;
...
">
        <div class="wrapper">
            ...
            <nav id="menu-1" class="offside">
                ...
                <ul>
                    <li>Menu</li>
                    <li><a href="{{url('/hotel/dashboard')}}">@lang('user.dashboard')</a></li>
                    <li><a href="{{url('/hotel/trips')}}">@lang('user.my_trips')</a></li>
                    <li><a href="{{url('/hotel/upcoming/trips')}}">@lang('user.upcoming_trips')</a></li>
                    <li><a href="{{url('/hotel/profile')}}">@lang('user.profile.profile')</a></li>
                    <li><a href="{{url('/hotel/change/password')}}">@lang('user.profile.change_password')</a></li>
                    <li><a href="{{ url('/hotel/logout') }}"
            ...
            <div id="container">
                ...
                <header>
                    ...
                    <div class="col-md-4" style="top:-10px;">
                        <div class="logo">
                            <img src="{{Setting::get('site_logo')}}" alt="" style="width: 100px">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="dropdown dropleft">
                          ...
                          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="{{url('/hotel/profile')}}">@lang('user.profile.profile')</a>
                            <a class="dropdown-item" href="{{url('/hotel/change/password')}}">@lang('user.profile.change_password')</a>
                            <a class="dropdown-item" href="{{ url('/hotel/logout') }}"
                                    onclick="event.preventDefault();
