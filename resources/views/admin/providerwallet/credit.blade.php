...
@section('content')
    ...
    <div class="content-area py-1">
		...
		<div class="text-center">
            ...
            <form class="" action="{{route('admin.providerwallet.debited')}}" method="POST" enctype="multipart/form-data" role="form">
            {{csrf_field()}}
			...
			<form class="" action="{{route('admin.providerwallet.store')}}" method="POST" enctype="multipart/form-data" role="form">
			{{csrf_field()}}
			<div class="text-left row" style="margin-left:30%;">
				<div class="col-md-12 row">
					<label style="position: relative; left:15px;top:9px;margin-right:10px;">{{ Setting::get('currency') }} </label><input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" required id="amount" name="amount" style="border-left:0px;border-right:0px;border-top:0px;width:80px" >
			...
			<div class="text-center mt-5">
                ...
                <button type="submit" id="submit" class="btn btn-outline-success btn-rounded w-min-sm m-l-0-75 waves-effect waves-light bg-success"  style="width:20%;">Add Money</button>
			</div>
			</form>
            ...
            <table class="table table-striped table-bordered dataTable" id="table-2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ date("Y-m-d h:i A", strtotime($providerwallet->updated_at))}}
                        </td>
                        <td>
                        </td>
                    </tr>
