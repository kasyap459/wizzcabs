        ...
        <div class="box box-block bg-white">
            <table class="table table-striped table-bordered dataTable" id="table-2">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $index + 1 }}</td>
                        <td><a href="{{ route('admin.provider.credit', $provider->id) }}" id="addwallet" data-id="{{ $provider->id }}">{{$provider->name}}</a>
                         </td>
                        <td>{{ $provider->email }}</td>
                        <td> {{ $provider->mobile }}</td>
                        <td>{{ Setting::get('currency', '$') }} {{ $provider->wallet_balance }}</td>
                        <td>
                        <div class="btn-group" role="group">
                            ...
                            <div class="dropdown-menu">
                                <a href="{{ route('admin.provider.credit', $provider->id) }}" class="dropdown-item">
