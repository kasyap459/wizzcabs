...
<!-- 				<div class="form-group row">
 ...
 -->				<div class="form-group row">
				...
				<!-- <div class="form-group row">
					...
					<div class="col-xs-6">
						<input class="form-control" type="text" value="{{ old('license_no') }}" name="license_no" required id="license_no" placeholder="License number">
					</div>
				</div>
				<div class="form-group row">
					<label for="license_expire" class="col-xs-3 col-form-label">License expire date</label>
					<div class="col-xs-6">
						<input class="form-control" type="text" value="{{ old('license_expire') }}" name="license_expire" required id="license_expire" placeholder="License expire date">
					</div>
				</div> -->
<!-- 				<div class="form-group row">
