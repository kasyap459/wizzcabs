   ...
   <div class="container-fluid">
      <div class="row bg-title">
         <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <a href="{{ route('admin.provider.index') }}" class="btn btn-outline-warning btn-rounded w-min-sm m-l-0-75 waves-effect waves-light">@lang('admin.list_drivers')</a>
         </div>
               ...
               <table class="viewtable">
                  <h6>
                     ...
                     <span style="display: inline-block;">
                        <form action="{{ route('admin.provider.document.remove',$provider->id) }}" method="POST">
                           {{ csrf_field() }}
               ...
               <form action="{{ route('admin.provider.document.store', $provider->id) }}" method="POST">
                  ...
                  <div class="col-xs-12">
                     <div class="col-xs-4">
                        ...
                        <div class="form-group row" style="display: none;" id="partner_id">
                           <label for="partner_id" >Carrier Name</label>
                              <select name="partner_id" required id="partner_id" class="form-control">
               ...
               <tr>
                  ...
                  <td>
                     <div class="input-group-btn">
                        ...
                        @if($document->id == $providerdocument->document_id) 
                        <a href="{{ route('admin.provider.document.edit', [$provider->id, $providerdocument->id]) }}" class="btn btn-sm btn-info btn-rounded b-a-0 waves-effect waves-light">@lang('admin.member.view')</a>
                        <form action="{{ route('admin.provider.document.destroy', [$provider->id, $providerdocument->document_id]) }}" method="POST" id="form-delete">
                           {{ csrf_field() }}
                           {{ method_field('DELETE') }}
