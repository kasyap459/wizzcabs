...
<div class="content-area py-1">
    <div class="container-fluid">
        ...
        <div class="box box-block bg-white">
            ...
            <!--<a href="{{ route('admin.ride.statement.partner') }}" style="margin-left: 1em;" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Create Invoice</a>-->
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu">
                                    <a href="{{ route('admin.invoiceview', $invoice->id) }}" class="dropdown-item">
                                        <i class="fa fa-pencil-square-o"></i> @lang('admin.member.view')
                                    </a>
                                    <a href="{{ route('admin.invoiceedit', $invoice->id) }}" class="dropdown-item">
                                        <i class="fa fa-pencil-square-o"></i> @lang('admin.member.edit')
                                    </a>
                                    <form action="{{ route('admin.invoicedelete', $invoice->id) }}" method="POST">
                                        {{ csrf_field() }}
...
<script type="text/javascript">
	...
	var APP_URL = {!! json_encode(url('/')) !!};
    	$("#table-2_filter").append('<a href="' + APP_URL + '/admin/statement/partner" style="margin-left: 1em;" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Create Invoice</a>');	
    });
</script>
@endsection