    		...
    		<div class="row">
    			<div class="col-md-3">
		            ...
		            <form class="form-horizontal" action="{{route('admin.location.store')}}" method="POST" enctype="multipart/form-data" role="form">
		            	...
		            	<input type="hidden" name="id" value="" id="iLocationid">
                        ...
                        <input type="hidden" class="form-control" name="clatitude" id="clatitude" value="">
                        <input type="hidden" class="form-control" name="clongitude" id="clongitude" value="">

						<div class="form-group row">
							<label for="location_name" class="col-xs-12 col-form-label">Location Name</label>
							<div class="col-xs-12">
								<input class="form-control" type="text" value="{{ old('location_name') }}" name="location_name" required id="location_name" placeholder="Location Name">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-xs-12">
								<button type="submit" class="btn btn-success" onclick="return IsEmpty();"> <i class="fa fa-check"></i> Add</button>
