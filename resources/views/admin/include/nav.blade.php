    ...
    <div class="sidebar-wrapper">
        <div class="user">
            ...
            <div class="user-info">
                ...
                <div class="collapse {{ request()->is('admin/profile') ? 'show' : '' }} {{ request()->is('admin/password') ? 'show' : '' }}"
                    id="collapseExample">
                    <ul class="nav">
                        ...
                        <li class="nav-item {{ request()->is('admin/password') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.password') }}">
                                <span class="sidebar-normal"><i class="ti-exchange-vertical"></i>
                                    @lang('admin.change_password')</span>
                            </a>
                        </li>
                        <li class="nav-item">
		...
		{{ request()->is('admin/hotel') ? 'show' : '' }}{{ request()->is('admin/customer-care') ? 'show' : '' }}"
            ...
            <li class="nav-item ">
                ...
                <div class="collapse {{ request()->is('admin/review/user') ? 'show' : '' }}{{ request()->is('admin/review/provider') ? 'show' : '' }}"
                    id="ratingExamples">
                    <ul class="nav">
                        <li class="nav-item {{ request()->is('admin/review/user') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.user.review') }}">
                                <span class="sidebar-normal"><i class="fa fa-circle" aria-hidden="true"
                                        style="color:#fff;font-size:8px;"></i>@lang('admin.user_ratings')</span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->is('admin/review/provider') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.provider.review') }}">
                                <span class="sidebar-normal"><i class="fa fa-circle" aria-hidden="true"
                                        style="color:#fff;font-size:8px;"></i>@lang('admin.driver_ratings')</span>
                            </a>
                        </li>
 ...
 -->
            ...
            {{-- <li class="nav-item ">
                <a class="nav-link" data-toggle="collapse" href="#walletExamples">
                    <img src="{{ asset('asset/img/wallet_management_icon.png') }}"
                        style="width: 24px;float: left;margin-left: 5px;margin-right: 15px;text-align: center;">
                    <p>Wallet Management
                        <b class="caret"></b>
                    </p>
                </a>
                <div class="collapse {{ request()->is('admin/userwallet') ? 'show' : '' }}{{ request()->is('admin/providerwallet') ? 'show' : '' }}"
                    id="walletExamples">
                    <ul class="nav">
                        <li class="nav-item {{ request()->is('admin/userwallet') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.userwallet.index') }}">
                                <span class="sidebar-normal"><i class="fa fa-circle" aria-hidden="true"
                                        style="color:#fff;font-size:8px;"></i>User Wallet</span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->is('admin/providerwallet') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.providerwallet.index') }}">
                                <span class="sidebar-normal"><i class="fa fa-circle" aria-hidden="true"
                                        style="color:#fff;font-size:8px;"></i>Driver Wallet</span>
                            </a>
                        </li>
                    </ul>
                </div>
		...
		{{ request()->is('admin/partner-document') ? 'show' : '' }} {{ request()->is('admin/corporate-document') ? 'show' : '' }}"
                    id="docsExamples">
                    <ul class="nav">
                        <li class="nav-item {{ request()->is('admin/document') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.document.index') }}">
                                <span class="sidebar-normal"><i class="fa fa-circle" aria-hidden="true"
                                        style="color:#fff;font-size:8px;"></i>Driver Document</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item {{ request()->is('admin/corporate-document') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.corporatedocument.index') }}">
                                <span class="sidebar-normal"><i class="fa fa-circle" aria-hidden="true"
                                        style="color:#fff;font-size:8px;"></i>Corporate Document</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            {{-- <li class="nav-item ">
                ...
                <div class="collapse {{ request()->is('admin/promocode') ? 'show' : '' }} {{ request()->is('admin/refferal') ? 'show' : '' }}"
                    id="marketingExamples">
                    <ul class="nav">
                        <li class="nav-item {{ request()->is('admin/promocode') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ url('admin/promocode') }}">
                                <span class="sidebar-normal"><i class="fa fa-circle" aria-hidden="true"
                                        style="color:#fff;font-size:8px;"></i>@lang('admin.promocodes')</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item {{ request()->is('admin/usercare') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.usercare') }}">
                    <img src="{{ asset('asset/img/customercare_icon.png') }}"
                        style="width: 24px;float: left;margin-left: 5px;margin-right: 15px;text-align: center;">
            ...
            <li class="nav-item ">
				...
				{{ request()->is('admin/password') ? 'show' : '' }}{{ request()->is('admin/business') ? 'show' : '' }}{{ request()->is('admin/page/*/edit') ? 'show' : '' }}"
                    id="settingsExamples">
                    <ul class="nav">
                        <li class="nav-item {{ request()->is('admin/settings') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.settings') }}">
                                <span class="sidebar-normal"><i class="fa fa-circle" aria-hidden="true"
                                        style="color:#fff;font-size:8px;"></i>@lang('admin.member.site_settings')</span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->is('admin/settings/payment') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.settings.payment') }}">
                                <span class="sidebar-normal"><i class="fa fa-circle" aria-hidden="true"
                                        style="color:#fff;font-size:8px;"></i>@lang('admin.payment_settings')</span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->is('admin/business') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.business') }}">
                                <span class="sidebar-normal"><i class="fa fa-circle" aria-hidden="true"
                                        style="color:#fff;font-size:8px;"></i>Business Settings</span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->is('admin/password') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.password') }}">
                                <span class="sidebar-normal"><i class="fa fa-circle" aria-hidden="true"
                                        style="color:#fff;font-size:8px;"></i>@lang('admin.change_password')</span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->is('admin/page/*/edit') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.page.edit', 2) }}">
                                <span class="sidebar-normal"><i class="fa fa-circle" aria-hidden="true"
                                        style="color:#fff;font-size:8px;"></i>Legal Settings</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item ">
                <a class="nav-link" data-toggle="collapse" href="#CMSsettingsExamples">
                    <img src="{{ asset('asset/img/cms_settings.png') }}"
                        style="width: 24px;float: left;margin-left: 5px;margin-right: 15px;text-align: center;">
                    <p>CMS Settings
                        <b class="caret"></b>
                    </p>
                </a>
                <div id="CMSsettingsExamples"
                    class="collapse {{ request()->is('admin/user-note') ? 'show' : '' }} {{ request()->is('admin/cms-settings') ? 'show' : '' }} {{ request()->is('admin/user-rating') ? 'show' : '' }}"
                    id="settingsExamples">
                    <ul class="nav">
                        <li class="nav-item {{ request()->is('admin/user-note') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.user-note.index') }}">
                                <span class="sidebar-normal"><i class="fa fa-circle" aria-hidden="true"
                                        style="color:#fff;font-size:8px;"></i>Trip Notes</span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->is('admin/user-rating') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.user-rating.index') }}">
                                <span class="sidebar-normal"><i class="fa fa-circle" aria-hidden="true"
                                        style="color:#fff;font-size:8px;"></i>Trip Ratings </span>
                            </a>
                        </li>
                        <li class="nav-item {{ request()->is('admin/cms-settings') ? 'active' : '' }}">
                            <a class="nav-link" href="cms-settings">
                                <span class="sidebar-normal"><i class="fa fa-circle" aria-hidden="true"
                                        style="color:#fff;font-size:8px;"></i>Other Contents </span>
                            </a>
                        </li>
                    </ul>
                </div>
