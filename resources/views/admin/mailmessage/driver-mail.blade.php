...
<div class="content-area py-1">
    <div class="container-fluid">
    	...
    	<div class="row bg-title">
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                <h4 class="page-title">Email Notification to Driver</h4><a href="{{ route('admin.mail.index') }}" class="btn btn-outline-warning btn-rounded w-min-sm m-l-0-75 waves-effect waves-light">Passenger Notification</a>
            </div>
        </div>

    	<div class="box box-block bg-white">
            <form class="form-horizontal" action="{{route('admin.mail.driverstore')}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						...
						<a href="{{route('admin.mail.driver.index')}}" class="btn btn-inverse waves-effect waves-light">@lang('admin.member.cancel')</a>
					</div>
				</div>
			</form>
		</div>
	...
	<div class="box box-block bg-white">
		<form action="{{ route('admin.mail.destroy') }}" method="POST">
			{{ csrf_field() }}
