							...
							<div class="box bg-white">
								<div class="box-block clearfix">
									...
									<div class="float-xs-right">
										<form action="{{ route('admin.partner.invoice.create') }}" method="POST">
										{{csrf_field()}}
										<div class="form-group col-md-2">
									        <input type="text" name="from_date" id="fromdate" autocomplete="off" onchange="update_content()" class="form-control" placeholder="From Date" style="border-color:#f59345;">
									    </div>
									    <div class="form-group col-md-2">
									        <input type="text" name="to_date" id="todate" autocomplete="off" onchange="update_content()" class="form-control" placeholder="To Date" style="border-color:#20b9ae;">
									    </div>
									    ...
									    <div class="form-group col-md-3">
											...
											<input type="hidden" name="partner_id" value="{{ $partnerid }}" id="partnerid">
										</div>
										<div class="form-group col-md-2">
											<button type="submit" class="btn">INVOICE</button>
										</div>
										</form>
									</div>
								</div>
...
<script>
    ...
    function update_content(){
        ...
        $('#table-statement').DataTable({
            ...
            "serverSide": true,
            "ajax":{
                     "url": "{{ route('admin.partner.partner-content') }}",
                     "dataType": "json",
                     "type": "POST",
                     "data":function ( d ) {
