            ...
            <div class="row bg-title">
                ...
                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Corporate Statement</li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-xs-12">
                        <div class="box box-block tile tile-2 bg-danger m-b-2">
                            ...
                            <div class="t-content">
                                ...
                                <h6 class="text-uppercase">Total No. Of Corporates</h6>
                            </div>
                        </div>
                    </div>
							...
							<div class="col-md-12">
									<div class="box bg-white">
										...
										@if(count($Corporates) != 0)
								            <table class="table table-striped table-bordered dataTable" id="statementcorporate-list">
								                <thead>
								                   <tr>
...
<script>
    function update_content(){
        $('#statementcorporate-list').DataTable({
            "destroy": true,
            "responsive": true,
            "dom": 'Bfrtip',
            "buttons": [
            ...
            "serverSide": true,
            "ajax":{
                     "url": "{{ route('admin.statement-corporatelist') }}",
                     "dataType": "json",
                     "type": "POST",
                     "data":function ( d ) {
