        ...
        <div class="container-fluid">
        	...
        	<div class="row bg-title">
	            ...
	            <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
	                <ol class="breadcrumb">
	                    ...
	                    <li class="active">@lang('admin.member.statement')</li>
	                </ol>
	            </div>
	        </div>
            ...
            <div class="box box-block bg-white">
            	<!-- <div style="text-align: center;padding: 20px;color: blue;font-size: 20px;">
            		<p><strong>
            			<span class="text-danger">@lang('admin.member.over_all_earning') : <i class="revenue"></i></span>
            			<br>
            			<span class="text-danger">@lang('admin.member.over_all_commission') : <i class="commission"></i></span>
            		</strong></p>
            	</div> -->
				...
				<div class="box-block clearfix">
					...
					<div class="float-xs-right">
					    ...
					    <div class="form-group col-md-3">
							...
							<input type="hidden" value="{{ $type_data }}" id="type_data">
						</div>
					</div>
				</div>
...
<script>
    ...
    function update_content(){
		...
		"bInfo": true,
            ...
            "ajax":{
                     "url": "{{ route('admin.statement-content') }}",
                     "dataType": "json",
                     "type": "POST",
     		     "autoWidth": false,
                     "data":function ( d ) {
