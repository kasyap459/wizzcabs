...
<head>
    ...
    <!-- Title -->
    <title>@yield('title'){{ Setting::get('site_title', 'vx') }}</title>
...
.dropdown-menu .dropdown-item:focus, .dropdown-menu .dropdown-item:hover, .dropdown-menu a:active, .dropdown-menu a:focus, .dropdown-menu a:hover p {
