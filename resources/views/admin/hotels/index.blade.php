    ...
    <div class="container-fluid">
        ...
        <div class="row bg-title">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <h4 class="page-title">Hotel/Restaurant</h4><a href="{{ route('admin.hotel.create') }}" class="btn btn-outline-warning btn-rounded w-min-sm m-l-0-75 waves-effect waves-light">Add Hotel/Restaurant</a>
            </div>
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                
                <ol class="breadcrumb">
                    <li><a href="{{ route('admin.dashboard') }}">@lang('admin.dashboard')</a></li>
                    <li class="active">List Hotel/Restaurant</li>
                </ol>
            </div>
        </div>
            ...
            <table class="table table-striped table-bordered dataTable" id="table-2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $hotel->name }}</td>
                        <td>{{ $hotel->email }}</td>
                        <td>{{ $hotel->dial_code }} {{ $hotel->mobile }}</td>
                        <td>@if($hotel->status ==1)
                                <a class="btn btn-success btn-rounded btn-sm waves-effect waves-light" href="{{ route('admin.hotel.inactive', $hotel->id) }}">Active</a>
                            @else
                                <a class="btn btn-danger btn-rounded btn-sm waves-effect waves-light" href="{{ route('admin.hotel.active', $hotel->id) }}">Inactive</a>
                            @endif
                        </td>
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu">
                                    <a href="{{ route('admin.hotel.edit', $hotel->id) }}" class="dropdown-item">
