...
@section('title', 'Add Hotel/Restaurant ')
...
<div class="content-area py-1">
    <div class="container-fluid">
    	...
    	<div class="box box-block bg-white">
    		<h5>Add Hotel/Restaurant</h5>
            <form class="form-horizontal" action="{{route('admin.hotel.store')}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
				...
				<div class="form-group row">
					<label for="picture" class="col-xs-12 col-form-label">Hotel/Restaurant logo</label>
					<div class="col-xs-8">
				...
				<div class="form-group row">
					...
					<div class="col-xs-8">
						<input class="form-control" type="text" value="{{ old('address') }}" onclick="initMap()" name="address" required id="address" placeholder="Address">
				...
				<div class="form-group row">
					...
					<div class="col-xs-8">
						<button type="submit" class="btn btn-success"> <i class="fa fa-check"></i> Add Hotel/Restaurant</button>
