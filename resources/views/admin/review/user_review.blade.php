        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <h4 class="page-title">@lang('admin.member.user_reviews')</h4>
                </div>
                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                    
                    <ol class="breadcrumb">
                        <li><a href="{{ route('admin.dashboard') }}">@lang('admin.dashboard')</a></li>
                        <li class="active">@lang('admin.member.user_reviews')</li>
                    </ol>
                </div>
            </div>
            <div class="box box-block bg-white">
                <table class="table table-striped table-bordered dataTable" id="user-review">
                    <thead>
                        <tr>
...
<script>
    function update_content(){
        $('#user-review').DataTable({
            ...
            "serverSide": true,
            "ajax":{
                     "url": "{{ route('admin.user.reviewuser') }}",
                     "dataType": "json",
                     "type": "POST",
