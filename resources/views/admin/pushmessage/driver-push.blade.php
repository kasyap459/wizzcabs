...
<div class="content-area py-1">
    <div class="container-fluid">
    	...
    	<div class="row bg-title">
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                <h4 class="page-title">Push Notification to Driver</h4><a href="{{ route('admin.push.index') }}" class="btn btn-outline-warning btn-rounded w-min-sm m-l-0-75 waves-effect waves-light">Passenger Notification</a>
            </div>
        </div>

    	<div class="box box-block bg-white">
            <form class="form-horizontal" action="{{route('admin.push.driverstore')}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
				...
				<div class="form-group row">
					<label for="push_content" class="col-xs-12 col-form-label">Title</label>
					<div class="col-xs-9">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						...
						<a href="{{route('admin.push.driver.index')}}" class="btn btn-inverse waves-effect waves-light">@lang('admin.member.cancel')</a>
					</div>
				</div>
			</form>
		</div>
	...
	<div class="box box-block bg-white">
		<form action="{{ route('admin.push.destroy') }}" method="POST">
			{{ csrf_field() }}
