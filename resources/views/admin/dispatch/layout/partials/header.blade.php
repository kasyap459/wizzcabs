			...
			<li class="nav-item dropdown">
				<a class="nav-link" href="#" data-toggle="dropdown" aria-expanded="false">
					<div class="avatar box-32">
						<img src="{{img(Auth::guard('admin')->user()->picture)}}" alt="" style="width: 100%;height: inherit;">
					</div>
				</a>
...
<!-- 					<a class="dropdown-item" href="#"><i class="ti-help mr-0-5"></i> @lang('admin.help')</a>
 -->					<a class="dropdown-item" href="{{ url('/admin/logout') }}"
		...
		<div class="navbar-toggleable-sm collapse" id="collapse-1">
			<ul class="nav navbar-nav">
<!-- 				<li class="nav-item">
					<a href="{{ route('admin.dashboard') }}" class="buttons btn btn-rounded w-min-sm m-l-0-75 waves-effect waves-light site-sidebar-second-toggle" data-toggle="collapse">Add</a>
				</li>
 -->				<li class="nav-item">
					<a href="{{ route('admin.main') }}" class="buttons btn btn-sm w-min-sm m-l-0-75 waves-effect waves-light">@lang('admin.triplist.trip_list')</a>
				</li>
				<li class="nav-item">
					<a href="{{ route('admin.schedule')}}" class="buttons btn btn-sm w-min-sm m-l-0-75 waves-effect waves-light">@lang('admin.triplist.scheduled_list')</a>
				</li>
				<li class="nav-item">
					<a href="{{ route('admin.dashboard') }}" class="buttons btn btn-sm w-min-sm m-l-0-75 waves-effect waves-light">@lang('admin.admin_dashboard')</a>
				</li>
<!-- 				<li class="nav-item" style=" margin-left: 50px; margin-top: 25px; color: #fff;">
				<img src="{{asset('asset/img/person_2.png')}}"  width="25"> Person <input type="checkbox" name="filter_list" value="person">
				</li>
 -->			
<!--  				<li class="nav-item" style="margin-top: 15px; color: #fff;">
				<img src="{{asset('asset/img/Green.png')}}"  width="30"> Active <input type="checkbox" name="filter_list" value="active">
				</li>
				<li class="nav-item" style="margin-top: 15px; color: #fff;">
				<img src="{{asset('asset/img/Blue.png')}}"  width="30"> Riding <input type="checkbox" name="filter_list" value="riding">
				</li>
				<li class="nav-item" style="margin-top: 15px; color: #fff;">
				<img src="{{asset('asset/img/Red.png')}}"  width="30"> Offline <input type="checkbox" name="filter_list" value="offline">
				</li>
 -->		          <select class="filter-box" style="margin-top: 18px;background-color: #231f20;color: #fff;" id="choose_corporate" 
 						onchange="driver_updates()">
		            ...
		            <select class="filter-box" style="margin-top: 18px;background-color: #231f20;color: #fff;"  id="choose_service" 
		            onchange="driver_updates()">
            ...
            <!--<select class="filter-box" style="margin-top: 18px;" id="driver_status" onchange="driver_updates()" style="display: none;">
                <option value="">All Status</option>
                <option value="active" class="text-success">Active <span class="ml-auto"><img src="{{asset('asset/img/Red.png')}}"  width="30"></span></option>
                <option value="offline" class="text-danger">Offline <span class="ml-auto">&#9673;</span></option>
                <option value="riding" class="text-info">Riding <span class="ml-auto">&#9673;</span></option>
                <option value="person" class="text-warning">Person <span class="ml-auto">&#128100;</span></option>
            </select>-->
