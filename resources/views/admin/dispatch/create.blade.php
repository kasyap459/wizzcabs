			...
			<p class="error-field d_address">Drop location required</p>
                  ...
                  <div class="row create-box text-black" style="padding-top: 0px">
                     <div class="col-md-6" style="padding: 5px 12px;">
                        ...
                        <input type="hidden" value="1" class="set_trip_type">
                     </div>
                  ...
                  <p class="error-field schedule_time_block"><span class="set_time"></span> Choose Appropriate Time</p>
                  ...
                  <div class="create-box text-black text-center mx-auto" style="text-align: center;padding-top:7px;">
                     ...
                     <button type="submit" id="submit" class="btn btn-sm justify mx-auto waves-effect waves-light submitter trip_btn" style="background-color: #27AB18;color:#fff;" onclick=>Create Trip</button>
