    	...
    	<div class="row bg-title">
            ...
            <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">@lang('admin.member.add_account_manager')</li>
                </ol>
            </div>
        </div>

    	<div class="box box-block bg-white">
			<h5>@lang('admin.member.add_account_manager')</h5>
            <form class="form-horizontal" action="{{route('admin.account-manager.store')}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-8">
						<button type="submit" class="btn btn-success"> <i class="fa fa-check"></i> @lang('admin.member.add_account_manager')</button>
