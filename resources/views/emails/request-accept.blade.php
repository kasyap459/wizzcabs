                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       <td align="left" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#3e4242; line-height:28px;"> 
                                          ...
                                          Your trip has been accepted and Driver will arrive to your location shortly.<br><br>
                                          <b>Trip Details : </b><br>
                                          <b>Trip ID: </b>{{ $user['booking_id'] }}<br>
                                          <b>Driver Name: ​</b>{{ $user['provider']['name'] }}<br>
                                          <b>Driver Mobile: </b>{{ $user['provider']['mobile'] }}<br>
