                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       <td align="left" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#3e4242; line-height:28px;"> 
                                          ...
                                          <b>Mintues Fare: </b>{{ $UserRequest->min_fare }}<br>
                                          <b>OnBoard Waiting Fare: </b>{{ $UserRequest->waiting_fare }}<br>
                                          <b>Syops Waiting Fare: </b>{{ $UserRequest->stop_waiting_fare }}<br>
                                          <b>Toll Fare: </b>{{ $UserRequest->toll }}<br>
                                           <b>Extra Fare: </b>{{ $UserRequest->extra_fare }}<br>
                                          <b>Tax: </b>{{  $UserRequest->vat  }}<br>
