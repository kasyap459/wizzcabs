                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       <td align="left" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#3e4242; line-height:28px;"> 
                                          <b>Hi {{ $user['user']['name'] }},</b><br> 
                                          Your trip has been completed successfully. Thanks for riding with  {{ config('app.name', 'Unicotaxi') }}.<br><br>
                                          <b>Trip Details :</b><br>
                                          <b>Trip ID: </b>{{ $user['booking_id'] }}<br>
                                          <b>Pickup Location: ​</b>{{ $user['s_address']}}<br>
                                          <b>Drop Location: ​</b>{{ $user['d_address']}}<br>
                                          <b>Distance: ​</b>{{ $user['distance']}} {{ Setting::get('distance_unit') }}<br>
                                          <b>Fare: ​</b>{{ Setting::get('currency') }}{{ $user['estimated_fare']}}<br>
                                          <b>Time: ​</b>{{ $user['finished_at']}}<br>
                                          <b>Payment Mode: </b>{{ $user['payment_mode']}}<br>
                                          <b>Taxi Number: </b>{{ $user['provider_service']['service_number'] }}  <br><br>
                                          Thanks,<br>
