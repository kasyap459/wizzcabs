...
<div class="main-banner-wrapper">
                             ...
                             <div class="col-lg-12 text-center">
                                <div class="banner-circle mt-5" style="background-image: url(web/images/slider/slider-2-1.jpg);">
                                    <div class="inner-block mt-5">
                                        <h3>Ahora disfrute  <br> de un viaje   <br> cómodo con  <br>  Pronto Taxi</h3>
                            ...
                            @endforeach
                                ...
                                <div class="col-lg-12">
                                    <div class="input-holder scheduleride" >
                                        <input type="text" name="schedule_time" id="schedule_time" placeholder="Seleccione Fecha">
                ...
                <div class="right-bottom-block">
                    <div class="content-block cta-block">
                        ...
                        <div class="text-block">
                            ...
                            <a href="callto:123-456-7890">1234567890</a>
                        </div><!-- /.text-block -->
                    </div><!-- /.content-block -->
                    ...
                    <div class="col-lg-4">
                        <div class="single-offer-one hvr-float-shadow">
                            ...
                            <div class="text-block">
                                ...
                                <p>Viaje diario. Recado al otro lado de la ciudad. Vuelo temprano en la mañana. Tarde<span id="dots2">...</span><span id="more2"> bebidas nocturnas. Dondequiera que vaya, cuente con Pronto Taxi para que lo lleve, no es necesario hacer reservaciones. Cobramos tarifas bajas y conducimos vehículos limpios y en buen estado, todo para garantizar un viaje placentero y asequible. Cuando necesite un servicio de taxi rápido y confiable, ¡cuente con nosotros!</span></p>
                    ...
                    <div class="col-lg-4">
                        <div class="single-offer-one hvr-float-shadow">
                            ...
                            <div class="text-block">
                                ...
                                <p>Tanto los pilotos como los vehículos están geolocalizados, una manera fácil de encontrarse<span id="dots3">...</span><span id="more3">. Para una perfecta transparencia y optimización del servicio, los pasajeros pueden calificar al conductor.</span></p>
      ...
      <!-- <hr class="style-one"> -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="content-block">
                            ...
                            <p>Brindamos a nuestros clientes la mejor experiencia posible al permitirles reservar un taxi sin problemas en cualquier momento con nuestra aplicación para pasajeros, repleta de funciones. Con inmensa experiencia en ofrecer los mejores servicios de transporte, permitimos a los usuarios tomar un taxi con un solo clic. Descargue e instale la aplicación de reserva de taxis desde App Store/Google Play Store ahora y disfrute de una experiencia de viaje sin complicaciones.</p>

                            <div class="button-block">
                                <a href="#" class="app-btn apple-btn mb-3">
                                    <i class="fa fa-apple icon"></i>
                                    <span class="text-block">
                                        <span class="tag-line">Descargar desde</span>
        ...
        <section class="cta-style-two no-zigzag">
            <div class="container">
                <div class="content-block">
                    <p>Haz una llamada o llena el formulario</p>
                    <h3>Llame a nuestro agente para <br> obtener una cotización.</h3>
                </div><!-- /.content-block -->
                <div class="button-block">
                    <a href="{{url('/book-taxi/es')}}" class="cta-btn">Reservar taxi ahora</a>
                </div><!-- /.button-block -->
            </div><!-- /.container -->
