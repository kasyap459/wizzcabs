    ...
    <div class="page-wrapper">
            ...
            <div class="top-bar">
                <div class="container">
                    ...
                    <div class="web/logo-block">
                        <a href="index.html"><img src="web/images/resources/logo-1-1.png" alt="Awesome Image" /></a>
                    </div><!-- /.logo-block -->
        ...
        <div class="main-banner-wrapper">
            <section class="banner-style-one owl-theme owl-carousel no-dots">
                <div class="slide slide-one" style="background-image: url(web/images/slider/slider-1-1.jpg);">
                    <div class="container">
                        <div class="row">
                ...
                <div class="slide slide-two" style="background-image: url(web/images/slider/slider-1-2.jpg);">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 text-center">
                                <h3 class="banner-title">Cheap & Trusted <br> Taxi Company</h3>
        ...
        <section class="book-ride-one">
            <img src="web/images/background/booking-bg-1-1.png" class="footer-bg" alt="Awesome Image" />
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                ...
                <div class="row high-gutter">
                    <div class="col-lg-6">
                        <div class="about-image-block">
                            <img src="web/images/resources/choise-1-1.png" alt="Awesome Image" />
                            ...
                            <div class="video-block-one">
                                <div class="image-block">
                                    <div class="inner-block">
                                        <img src="web/images/resources/video-1-1.png" alt="Awesome Image" />
                    ...
                    <div role="tabpanel" class="tab-pane show active  animated fadeInUp" id="hybrid">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="single-taxi-one">
                                    <div class="inner-content">
                                        <img src="web/images/pricing/pricing-1-1.png" alt="Awesome Image" />
                                        <div class="icon-block">
                            ...
                            <div class="col-lg-4">
                                <div class="single-taxi-one">
                                    <div class="inner-content">
                                        <img src="web/images/pricing/pricing-1-2.png" alt="Awesome Image" />
                                        <div class="icon-block">
                            ...
                            <div class="col-lg-4">
                                <div class="single-taxi-one">
                                    <div class="inner-content">
                                        <img src="web/images/pricing/pricing-1-3.png" alt="Awesome Image" />
                                        <div class="icon-block">
        ...
        <div class="brand-carousel-wrapper">
            <div class="container">
                <div class="brand-carousel-one owl-theme owl-carousel">
                    <div class="item">
                        <img src="web/images/brand/brand-1-1.jpg" alt="Awesome Image" />
                    </div><!-- /.item -->
                    <div class="item">
                        <img src="web/images/brand/brand-1-2.jpg" alt="Awesome Image" />
                    </div><!-- /.item -->
                    <div class="item">
                        <img src="web/images/brand/brand-1-3.jpg" alt="Awesome Image" />
                    </div><!-- /.item -->
                    <div class="item">
                        <img src="web/images/brand/brand-1-4.jpg" alt="Awesome Image" />
                    </div><!-- /.item -->
                    <div class="item">
                        <img src="web/images/brand/brand-1-5.jpg" alt="Awesome Image" />
                    </div><!-- /.item -->
                    <div class="item">
                        <img src="web/images/brand/brand-1-1.jpg" alt="Awesome Image" />
                    </div><!-- /.item -->
        ...
        <section class="feature-style-one thm-black-bg">
            <img src="web/images/background/feature-bg-1-1.png" alt="Awesome Image" class="feature-bg" />
            <div class="container">
                <div class="block-title text-center">
                    <div class="dot-line"></div><!-- /.dot-line -->
        ...
        <section class="testimonials-style-one">
            <div class="container">
                ...
                <div class="testimonials-one-pager">                    
                    <a href="#" class="pager-item active" data-slide-index="1"><img src="web/images/resources/testi-1-1.jpg" alt="Awesome Image" /></a>
                    <a href="#" class="pager-item" data-slide-index="2"><img src="web/images/resources/testi-1-2.jpg" alt="Awesome Image" /></a>
                    <a href="#" class="pager-item" data-slide-index="3"><img src="web/images/resources/testi-1-3.jpg" alt="Awesome Image" /></a>
                        ...
                        <div class="single-blog-style-one">
                            <div class="image-block">
                                <div class="inner-block">
                                    ...
                                    <img src="web/images/blog/blog-1-1.jpg" alt="Awesome Image" />
                                </div><!-- /.inner-block -->
                            </div><!-- /.image-block -->
                            <div class="text-block">
                                <div class="meta-info">
                            ...
                            <div class="col-xl-12 col-lg-6">
                                <div class="single-blog-style-two">
                                    <div class="image-block">
                                        <div class="inner-block">
                                            <a href="blog-details.html"><i class="fa fa-link"></i></a>
                                            <img src="web/images/blog/blog-2-1.jpg" alt="Awesome Image" />
                                        </div><!-- /.inner-block -->
                                    </div><!-- /.image-block -->
                                    <div class="text-block">
                                        <a href="#" class="date-block">20 Feb, 2019</a>
                            ...
                            <div class="col-xl-12 col-lg-6">
                                <div class="single-blog-style-two">
                                    <div class="image-block">
                                        <div class="inner-block">
                                            <a href="blog-details.html"><i class="fa fa-link"></i></a>
                                            <img src="web/images/blog/blog-2-2.jpg" alt="Awesome Image" />
                                        </div><!-- /.inner-block -->
                                    </div><!-- /.image-block -->
                                    <div class="text-block">
                                        <a href="#" class="date-block">20 Feb, 2019</a>
