<!-- .modal -->
<div class="modal right fade" id="myModal" style="top: 70px;padding-left: 17px;">
...
<!-- 		     <div class="col-md-6" style="display: flex;padding-left: 8px;">
			<select class="form-control" id="corporate_name" name="corporate_name" style="height: 30px;">
 ...
 -->                
                     <input type="hidden" class="form-control" id="corporate_id" name="corporate_id" value="{{ Auth::guard('corporate')->user()->id }}"placeholder="Corporate ID" style="width: 65px;height: 33px;padding-left: 0px; margin-left: -15px;">
                  </div>
                  ...
                  <div class="create-box text-black">
                     ...
                     <div class="ss-checkbox"><input type="checkbox" id="provider_auto_assign" name="provider_auto_assign" 
                        @if(Setting::get('auto_assign', 0) == 1) checked @endif class="js-switch" data-color="#f59345" /></div>
                  </div>
