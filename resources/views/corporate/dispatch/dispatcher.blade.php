@extends('corporate.dispatch.layout.base')
...
<div class="site-sidebar-second custom-scroll custom-scroll-dark">
   ...
   <div class="tab-content">
      <div class="tab-pane active" id="tab-1" role="tabpanel">
         ...
         @include('corporate.dispatch.create')
      </div>
         ...
         <div class="sidebar-chat animated fadeIn">
            <form action="" id="corporate_trip">
               <div class="sidebar-group">
                  ...
                  <div class="create-box text-black">
                     <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" id="c_mobile" name="c_mobile" placeholder="Phone Number">
...
@include('corporate.dispatch.layout.partials.header')
...
<script>
   $( "#first_name" ).autocomplete({
         source : '/corporate/dispatch/users-corporate',
         minlenght:3,
         autoFill:true,
   ...
   $( "#mobile" ).autocomplete({
         source : '/corporate/dispatch/users-phone',
         minlenght:3,
         autoFill:true,
         select:function(e,ui){
           $('#mobile').val(ui.item.value);
   ...
   $( "#email" ).autocomplete({
         source : '/corporate/dispatch/users-email',
         minlenght:3,
         autoFill:true,
         select:function(e,ui){
   ...
   $( "#corporate_name" ).autocomplete({
         source : '/corporate/dispatch/corporate-user',
         minlenght:3,
         autoFill:true,
         select:function(e,ui){
   ...
   $("#corporate_trip").submit(function(event){
     $('.alert').hide();
       ...
       $.ajax({
           url: '/corporate/dispatch/corporate',
           dataType: 'json',
           headers: {'X-CSRF-TOKEN': window.Laravel.csrfToken },
           type: 'POST',
   ...
   function viewer(id){
       $("#loader").show();
       $("#viewer").empty();
       $.get('/corporate/dispatch/viewtrip/' +id, function( data ) {
               $("#viewer").html(data);
               $("#loader").hide();
          });
   }
   $(document).on('click','#assign', function() {
       ...
       $.get('/corporate/dispatch/assign/' +id+'/'+provider_id, function( data ) {
               activeTab('tab-2');
               ride_updates();
          });
   });
   ...
   function ride_updates(){
       $.ajax
           ({
             cache: false,
             type: "GET",
             url: "/corporate/dispatch/ride-list",
             success: function(data)
             {
                $('.ride_list').html(data);
             }
