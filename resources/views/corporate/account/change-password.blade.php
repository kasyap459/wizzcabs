    ...
    <div class="container-fluid">
    	...
    	<div class="row bg-title">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <a href="{{ route('corporate.profile') }}" class="btn btn-outline-warning btn-rounded w-min-sm m-l-0-75 waves-effect waves-light">@lang('admin.account_settings')</a>
                <a href="{{ route('corporate.password') }}" class="btn btn-outline-warning btn-rounded w-min-sm m-l-0-75 waves-effect waves-light active">@lang('admin.change_password')</a>
            </div>
        </div>
    	...
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('corporate.password.update')}}" method="POST" role="form">
            	{{csrf_field()}}
