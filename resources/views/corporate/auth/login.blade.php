@extends('corporate.layout.auth')

@section('content')
<form class="login100-form validate-form" method="POST" action="{{ url('/corporate/login') }}">
    ...
    <div class="p-b-50 p-t-20">
      ...
      <a href="{{ url('/corporate/login') }}" class="login100-form-btn custom-btn activepage">Corporate</a>
    ...
    <div class="container-login100-form-btn">
      ...
      <a href="{{ url('/corporate/password/reset') }}" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
        Forgot Password
