...
@section('content')
<form class="login100-form validate-form" method="POST" action="{{ url('/corporate/password/email') }}">
    ...
    <div class="container-login100-form-btn">
      ...
      <a href="{{ url('/corporate/login') }}" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
        Sign In
