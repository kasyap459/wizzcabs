...
<form class="login100-form validate-form" method="POST" name="form1" onsubmit="return checkStuff()" action="{{ url('/account/login') }}">
    ...
    <div class="container-login100-form-btn">
      ...
      <a href="{{ url('/account/password/reset') }}" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
        Forgot Password
