        ...
        <div class="container-fluid">
        	<div class="row bg-title">
                ...
                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="{{ route('account.dashboard') }}">@lang('admin.dashboard')</a></li>
							...
							<div class="col-md-12">
									<div class="box bg-white">
										...
										@if(count($Providers) != 0)
								            <table class="table table-striped table-bordered dataTable" id="statementprovider-list">
								                <thead>
								                   <tr>
...
<script>
    function update_content(){
        $('#statementprovider-list').DataTable({
            ...
            "serverSide": true,
            "ajax":{
                     "url": "{{ route('account.statement-providerlist') }}",
                     "dataType": "json",
                     "type": "POST",
