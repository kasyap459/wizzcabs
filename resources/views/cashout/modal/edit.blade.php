<form action="{{route('admin.storedetail', $request->id )}}" method="POST" id="senddata" role="form" enctype="multipart/form-data">
    {{csrf_field()}}
    <input type="hidden" name="_method" value="PATCH">
            ...
            <div class="form-group row">
                    ...
                    <div class="col-xs-6">
                        ...
                        <input class="form-control" type="text" value="{{ !empty($request->user->mobile) ? $request->user->mobile : ' ' }}" name="mobile" required id="mobile" placeholder="@lang('admin.member.mobile_number')" disabled>
                    </div>
            </div>
            <div class="form-group row">
                    <div class="col-xs-6">
  ...
  $("#senddata").submit(function(stay){
   var formdata = $(this).serialize(); // here $(this) refere to the form its submitting
    $.ajax({
        type: 'POST',
        url: "{{ route('admin.storedetail', $request->id ) }}",
