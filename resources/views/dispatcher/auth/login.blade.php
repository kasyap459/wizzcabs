...
@section('content')
<form class="login100-form validate-form" method="POST" action="{{ url('/dispatcher/login') }}">
    ...
    <div class="container-login100-form-btn">
      ...
      <a href="{{ url('/dispatcher/password/reset') }}" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
        Forgot Password
