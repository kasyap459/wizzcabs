<div class="site-header">
	<nav class="navbar navbar-dark">
		...
		<div class="navbar-toggleable-sm collapse" id="collapse-1">
			<ul class="nav navbar-nav">
				<!--<li class="nav-item">
					<a href="{{ route('dispatcher.dispatch.index') }}" class="buttons btn btn-rounded w-min-sm m-l-0-75 waves-effect waves-light site-sidebar-second-toggle" data-toggle="collapse">Add</a>
				</li>-->
				<li class="nav-item">
					<a href="{{ route('dispatcher.main') }}" class="buttons btn btn-sm w-min-sm m-l-0-75 waves-effect waves-light">@lang('admin.triplist.trip_list')</a>
				</li>
				<li class="nav-item">
					<a href="{{ route('dispatcher.schedule') }}" class="buttons btn btn-sm w-min-sm m-l-0-75 waves-effect waves-light">@lang('admin.triplist.scheduled_list')</a>
				</li>
				<select class="filter-box" style="margin-top: 18px;;background-color: #231f20;color: #fff;" id="choose_corporate" onchange="driver_updates()">
		            ...
		            <select class="filter-box" style="margin-top: 18px;;background-color: #231f20;color: #fff;"  id="choose_service" onchange="driver_updates()">
