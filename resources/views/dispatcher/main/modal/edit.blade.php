<form action="{{route('dispatcher.storedetail', $request->id )}}" method="POST" id="senddata" role="form" enctype="multipart/form-data">
    {{csrf_field()}}
  ...
  $("#senddata").submit(function(stay){
   var formdata = $(this).serialize(); // here $(this) refere to the form its submitting
    $.ajax({
        type: 'POST',
        url: "{{ route('dispatcher.storedetail', $request->id ) }}",
