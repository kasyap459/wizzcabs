...
<div class="cps-section cps-section-padding custom-padding">
    ...
    <div class="row">
        <div class="agile_info">
            <div class="w3_info">
                <h2>Login Here</h2>
                    <form id="provider_registration" action="{{ url('/provider/login') }}" method="POST" autocomplete="off">
                    {{ csrf_field() }}
                    ...
                    <div class="left">
                        ...
                        <div class="input-group">
                            ...
                            <input class="width" id="password" type="password" name="password" placeholder="Password" autocomplete="off"/>
                ...
                <div class="login-with-social">
                   <a class="gplus-login" href="{{ url('provider/auth/google') }}"><i class="fa fa-google-plus"></i> Sign in via Google Plus</a>
...
$(document).ready(function(){
    $('#login').on('click',function(e){
        ...
        if(password.length != 6){
           // $("#custom_success .msg").hide();
            $("#custom_err .msg").show();
           // alert('Invalid OTP');
            $("#custom_success .msg").text('Please check O T P');
            $("#custom_err .msg").show();
            return false;
        }
    }); 
