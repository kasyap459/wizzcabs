<div class="site-header">
	<nav class="navbar navbar-dark">
			...
			<li class="nav-item dropdown">
				<a class="nav-link" href="#" data-toggle="dropdown" aria-expanded="false">
					<div class="avatar box-32">
						<img src="{{img(Auth::guard('partner')->user()->logo)}}" alt="">
					</div>
				</a>
		...
		<div class="navbar-toggleable-sm collapse" id="collapse-1">
			<ul class="nav navbar-nav">
				<!--<li class="nav-item">
					<a href="{{ route('partner.dashboard') }}" class="buttons btn btn-sm w-min-sm m-l-0-75 waves-effect waves-light site-sidebar-second-toggle" data-toggle="collapse">Add</a>
				</li>-->
				<li class="nav-item">
					<a href="{{ route('partner.main') }}" class="buttons btn btn-sm w-min-sm m-l-0-75 waves-effect waves-light">@lang('admin.triplist.trip_list')</a>
				</li>
				<li class="nav-item">
					<a href="{{ route('partner.dashboard') }}" class="buttons btn btn-sm w-min-sm m-l-0-75 waves-effect waves-light">@lang('admin.dashboard')</a>
				</li>
			</ul>


		            <select class="filter-box" style="margin-top: 18px;background-color: #35363a;color: #fff;"  id="choose_service" onchange="driver_updates()">
