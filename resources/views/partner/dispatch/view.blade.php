<div class="sidebar-chat-window">
	...
	<div class="n-item">
		<div class="media">
			...
			<div class="n-text"><strong>To: </strong>{{ \Illuminate\Support\Str::limit($trip->s_address, 40) }}</div>
			<div class="n-text"><strong>To: </strong>{{ \Illuminate\Support\Str::limit($trip->d_address, 40) }}</div>
