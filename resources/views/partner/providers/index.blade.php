    ...
    <div class="container-fluid">
        ...
        <div class="row bg-title">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <h4 class="page-title">@lang('admin.member.drivers')</h4><a href="{{ route('partner.provider.create') }}" class="btn btn-outline-warning btn-rounded w-min-sm m-l-0-75 waves-effect waves-light">@lang('admin.member.add_new_driver')</a>
            </div>
...
<script>
    function update_content(){
        $('#provider-list').DataTable({
            ...
            "serverSide": true,
            "ajax":{
                     "url": "{{ route('partner.provider.row') }}",
                     "dataType": "json",
                     "type": "POST",
                     "data":function ( d ) {
                            d._token = "{{csrf_token()}}";
