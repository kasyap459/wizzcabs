                @foreach($trips as $index => $trip)
                   ...
                   <tr style="background-color:#ccc">
                        ...
                        <td>{{ \Illuminate\Support\Str::limit($trip->s_address, 40) }} </td>
                        <td>{{ \Illuminate\Support\Str::limit($trip->d_address, 40) }} </td>
                        ...
                        <td>
                            ...
                            @elseif($trip->status == 'SEARCHING')
                                ...
                                <a href="#" id="editmodal1" class="icontrip" data-id="{{ $trip->id }}"><i class="fa fa-edit"></i></a>
