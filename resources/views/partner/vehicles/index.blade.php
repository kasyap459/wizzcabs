    ...
    <div class="container-fluid">
        ...
        <div class="row bg-title">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <h4 class="page-title">Vehicles</h4><a href="{{ route('partner.vehicle.create') }}" class="btn btn-outline-warning btn-rounded w-min-sm m-l-0-75 waves-effect waves-light">Add new Vehicle</a>
            </div>
