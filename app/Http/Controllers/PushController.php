...
class PushController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            $pushdatas = MemberNotification::where('notification_type','push')->where('member','passenger')->orderBy('created_at' , 'desc')->get();
    ...
    public function driver_index()
    {
        try{
            ...
            $pushdatas = MemberNotification::where('notification_type','push')->where('member','driver')->orderBy('created_at' , 'desc')->get();
